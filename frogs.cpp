...
void     MoveBalls                (char* name_user, int* continue_game, int* r_ball, int* main_heroes, char* name_file_image, char* name_file_frog1, char* name_file_frog2, char* name_file_frog3);
void     DrawBackground           ();
...
int main ()
    ...
    MoveBalls (name_user, &continue_game, &r_ball, &main_heroes, name_file_image, name_file_frog1, name_file_frog2, name_file_frog3);
...
void MoveBalls (char* name_user, int* continue_game, int* r_ball, int* main_heroes, char* name_file_image, char* name_file_frog1, char* name_file_frog2, char* name_file_frog3)
    {
    if (*main_heroes == 1 && *r_ball == 30) name_file_image = "Images\\fly_60pix.bmp";
    if (*main_heroes == 2 && *r_ball == 30) name_file_image = "Images\\dragonfly_60pix.bmp";
    if (*main_heroes == 3 && *r_ball == 30) name_file_image = "Images\\bumblebee_60pix.bmp";

    if (*main_heroes == 1 && *r_ball == 20) name_file_image = "Images\\fly_40pix.bmp";
    if (*main_heroes == 2 && *r_ball == 20) name_file_image = "Images\\dragonfly_40pix.bmp";
    if (*main_heroes == 3 && *r_ball == 20) name_file_image = "Images\\bumblebee_40pix.bmp";
